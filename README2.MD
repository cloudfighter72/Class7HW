...
Security Groups:
- Build a Security Group (Ports 22 and 80)
...
- Build an EC2 Instance (Amazon Linux based 2023)
...
- Open a new tab on your web browser and type "http://<public DNS> and press ENTER.
...
- Look for the Bird and the "Amazon Linux 2023" logo at the top.

Modify EC2 Script and refresh the WebServer page:
- From the command line type the following command: sudo vim /var/www/html/index.html
...
- Paste updated image file on the line after "<img src="
- Press the "Esc" button
- Type the command :wq and Press Enter
- Refresh the web page to show web connectivity

Ping IP address 8.8.8.8 (Google DNS) from the Amazon Linux page
