...
- USE WHATEVER NAME YOU WANT--->COPY AND PASTE INTO DESCRIPTION
...
- INSTANCES / check instance you want terminated
- INSTANCE STATE / terminate (delete) instance (wait a minute before doing the next steps)
- SECURITY GROUPS / check your security group / click ACTIONS / delete security groups
